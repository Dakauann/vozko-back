...
func TestIntegration_GetStatsCountsEveryColumn(t *testing.T) {
	...
	analyzed := []ca.Classification{
		...
		lvl(shared.SentimentNegative, ca.StanceHostile, ca.IntentOther, "other", false, shared.QualityLevelHigh),
		lvl(shared.SentimentNegative, ca.StanceHostile, ca.IntentSalesLead, "other", false, shared.QualityLevelHigh),
		lvl(shared.SentimentNegative, ca.StanceHostile, ca.IntentSpam, "other", true, shared.QualityLevelHigh),
	}
	analyzed[8].PersonalAttack = shared.QualityLevelHigh
	analyzed[9].PersonalAttack = shared.QualityLevelHigh
	analyzed[10].PersonalAttack = shared.QualityLevelHigh
	...
	checks := map[string][2]int{
		...
		"RequiresActionCount":  {c.RequiresActionCount, 8},
		"DistinctAuthors":      {c.DistinctAuthors, 7},
	}
	...
	if account == nil || account.Analyzed != 12 {
