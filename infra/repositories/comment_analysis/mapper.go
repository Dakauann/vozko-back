...
func toDomain(row *schema.CommentAnalysis) *ca.CommentAnalysis {
	if row == nil {
		return nil
	}
	a := &ca.CommentAnalysis{
		ID:               row.ID,
...
func toDomainSlice(rows []schema.CommentAnalysis) []*ca.CommentAnalysis {
	out := make([]*ca.CommentAnalysis, 0, len(rows))
	for i := range rows {
...
func fromDomain(a *ca.CommentAnalysis) *schema.CommentAnalysis {
	row := &schema.CommentAnalysis{
		ID:               a.ID,
		WorkspaceID:      a.WorkspaceID,
		Source:           string(a.Source),
		AccountID:        a.AccountID,
		ContainerID:      a.ContainerID,
		SourceCommentID:  a.SourceCommentID,
...
func settingsToDomain(row *schema.CommentAnalysisSettings) (*ca.Settings, error) {
	s := &ca.Settings{
		WorkspaceID:  row.WorkspaceID,
		Source:       ca.Source(row.Source),
		AccountID:    row.AccountID,
...
func settingsFromDomain(s *ca.Settings) (*schema.CommentAnalysisSettings, error) {
...
func authorToDomain(row *schema.CommentAnalysisAuthor) (*ca.AuthorStats, error) {
	a := &ca.AuthorStats{
		ID:               row.ID,
		WorkspaceID:      row.WorkspaceID,
		Source:           ca.Source(row.Source),
...
func authorFromDomain(a *ca.AuthorStats) (*schema.CommentAnalysisAuthor, error) {
	...
	return &schema.CommentAnalysisAuthor{
		ID:               a.ID,
		WorkspaceID:      a.WorkspaceID,
		Source:           string(a.Source),
		AccountID:        a.AccountID,
...
func rollupToDomain(row *schema.CommentAnalysisRollup) (*ca.Rollup, error) {
	r := &ca.Rollup{
		WorkspaceID:     row.WorkspaceID,
		Source:          ca.Source(row.Source),
		AccountID:       row.AccountID,
...
func rollupFromDomain(r *ca.Rollup) (*schema.CommentAnalysisRollup, error) {
	counters, err := json.Marshal(r.Counters)
	if err != nil {
		return nil, err
	}
	return &schema.CommentAnalysisRollup{
...
func batchFromDomain(b *ca.Batch) *schema.CommentAnalysisBatch {
	return &schema.CommentAnalysisBatch{
		ID:               b.ID,
...
func backfillToDomain(row *schema.CommentAnalysisBackfill) *ca.Backfill {
	return &ca.Backfill{
		ID:                row.ID,
		WorkspaceID:       row.WorkspaceID,
		Source:            ca.Source(row.Source),
...
func backfillFromDomain(b *ca.Backfill) *schema.CommentAnalysisBackfill {
	return &schema.CommentAnalysisBackfill{
		ID:                b.ID,
		WorkspaceID:       b.WorkspaceID,
		Source:            string(b.Source),
		AccountID:         b.AccountID,
...
func overrideToDomain(row *schema.CommentAnalysisContainerSettings) (*ca.ContainerOverride, error) {
...
func overrideFromDomain(o *ca.ContainerOverride) (*schema.CommentAnalysisContainerSettings, error) {
	row := &schema.CommentAnalysisContainerSettings{
