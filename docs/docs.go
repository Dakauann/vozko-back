...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/comment-analysis/alerts/options": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/comment-analysis/alerts/{id}/test": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/comment-analysis/authors/{id}/containers": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/comment-analysis/backfill/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID do reprocessamento",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/comment-analysis/backfill/{id}/cancel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/comment-analysis/backfill/{source}/{accountId}": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/comment-analysis/backfill/{source}/{accountId}/estimate": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/comment-analysis/escalation-recipients": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/comment-analysis/trends": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "account|container|topic",
                        "name": "scope",
                        "in": "query",
                        "required": true
                    },
        ...
        "/comment-analysis/{id}/reply/suggest": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/lead.ImportLeadsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/lead.ImportLeadsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/lead.RenameLeadRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/stages": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID do funil (tem precedência sobre a campanha)",
                        "name": "pipelineId",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "attendance.Overview": {
            ...
            "properties": {
                ...
                "stages": {
                    "description": "Stages is where the scoped conversations are sitting, grouped by the\nfunnel that owns each stage. See stage_distribution.go.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/attendance.OverviewStages"
                        }
                    ]
                },
                "status_distribution": {
        ...
        "attendance.OverviewStages": {
            "type": "object",
            "properties": {
                "available": {
                    "description": "true when anything in scope is staged",
                    "type": "boolean"
                },
                "funnels": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/attendance.StageFunnelGroup"
                    }
                },
                "staged_engaged": {
                    "type": "integer"
                ...
                "unstaged_engaged": {
                    "description": "Unstaged is scoped minus staged: conversations carrying no stage at all.\nReported as a total rather than as a fake stage row.",
                    "type": "integer"
                },
                "unstaged_shell": {
                    "type": "integer"
        ...
        "attendance.StageFunnelGroup": {
            ...
            "properties": {
                ...
                "funnel_id": {
                    "description": "FunnelID is empty for the single no-funnel bucket, which always sorts last.",
                    "type": "string"
                },
                "funnel_name": {
                    "type": "string"
                ...
                "stages": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/attendance.StageRow"
                    }
                },
                "stuck": {
                    "type": "integer"
        ...
        "attendance.StageRow": {
            ...
            "properties": {
                "avg_days_in_stage": {
                    "description": "AvgDaysInStage and OldestDaysInStage measure OPEN engaged conversations\nagainst now, not against the period end. Null when nothing here is open,\nbecause 0 would read as \"everyone arrived today\".",
                    "type": "number"
                },
                "color": {
                    "description": "Color is the stage's own kanban colour when the workspace picked one.",
                    "type": "string"
                },
                "engaged": {
                    "description": "Engaged is THE number: conversations with at least one message, the same\nuniverse as the KPI strip and every other panel on the page.",
                    "type": "integer"
                },
                "finished": {
                    "type": "integer"
                ...
                "pct_of_funnel": {
                    "description": "PctOfFunnel answers \"where inside this path do they stop\", PctOfStaged\nanswers \"which funnel owns the workspace's volume\". Both over Engaged.",
                    "type": "number"
                },
                "pct_of_staged": {
                    "type": "number"
                ...
                "rot_days_set": {
                    "description": "RotDaysSet distinguishes a threshold the workspace chose from the product\ndefault, so the UI can name which one produced the count.",
                    "type": "boolean"
                },
                "shell": {
                    "description": "Shell is campaign/import rows parked here that were never messaged. Shown\nbeside Engaged, never added to it.",
                    "type": "integer"
                },
                "stage_id": {
                    "type": "string"
                ...
                "stuck": {
                    "description": "Stuck is open engaged conversations sitting longer than StuckAfterDays.",
                    "type": "integer"
                },
                "stuck_after_days": {
                    "type": "integer"
        ...
        "lead.ImportLeadsRequest": {
            "type": "object",
            "properties": {
                "onExisting": {
                    "description": "OnExisting is \"fill_empty\" (default) or \"skip\". Never an overwrite:\nsee lead.ExistingPolicy.",
                    "type": "string",
                    "example": "fill_empty"
                },
                "rows": {
        ...
        "lead.ImportLeadsResponse": {
            "type": "object",
            "properties": {
                "blocked": {
                    "description": "Blocked: how many of the matched are blocked, and so unreachable by a\ncampaign built on this list.",
                    "type": "integer"
                },
                "created": {
                    "description": "Created: leads that did not exist in this workspace before.",
                    "type": "integer"
                },
                "duplicate": {
                ...
                "invalid": {
                    "description": "Invalid: rows whose number is not a reachable phone number.",
                    "type": "integer"
                },
                "matched": {
                    "description": "Matched: rows whose number the workspace already knew.",
                    "type": "integer"
                },
                "rejected": {
                    "description": "Rejected lists the rows that did not make it, capped at\nMaxReportedRejections. Rejections are reported, never silently dropped:\nan operator told \"480 importados\" out of 500 with no list of the other 20\nhas a file they cannot repair.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/lead.ImportRejection"
                    }
                },
                "rejectedTruncated": {
                    "description": "RejectedTruncated says the list above was cut, so the UI can say \"+N\"\nrather than implying it showed everything.",
                    "type": "integer"
                }
            }
        },
        "lead.ImportRejection": {
            "type": "object",
            "properties": {
                "line": {
                    "type": "integer",
                ...
                "reason": {
                    "description": "Reason is \"invalid\" (not a reachable number) or \"duplicate\" (repeated\nearlier in the same file).",
                    "type": "string",
                    "example": "invalid"
                }
            }
        ...
        "stage.CreateTagRequest": {
            ...
            "properties": {
                ...
                "pipelineId": {
                    "description": "PipelineID is the funnel the new stage joins. Omit it and the stage lands on\nthe workspace default funnel.",
                    "type": "string",
                    "example": "pl_a1b2c3"
                }
            }
            ...
            "properties": {
                "days": {
                    ...
                    "additionalProperties": {
                        "type": "array",
                        "items": {
                            "$ref": "#/definitions/working_hours.Window"
                        }
                    }
                },
                "timezone": {
        ...
        "workspacedepartment.DepartmentResponse": {
            ...
            "properties": {
                ...
                "workingHours": {
                    "description": "WorkingHours is set only when this department overrides the workspace\nschedule; absent means it inherits.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/working_hours.Spec"
                        }
        ...
        "workspacedepartment.UpdateDepartmentRequest": {
            ...
            "properties": {
                ...
                "workingHours": {
                    "description": "WorkingHours is this department's own weekly schedule. Send null to clear\nit and inherit the workspace's; omit it to leave it unchanged.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/working_hours.Spec"
                        }
