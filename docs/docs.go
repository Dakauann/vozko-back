        ...
        "/attendance/overview/{section}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Métrica de ordenação da equipe (apenas team)",
                        "name": "rank_metric",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Meses da série histórica (apenas trend)",
                        "name": "trend_buckets",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Incluir agentes de IA (apenas team)",
                        "name": "include_ai",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/attendance.SummarySection"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "conversation.EntryWithLastMessage": {
            ...
            "properties": {
                ...
                "close": {
                    "$ref": "#/definitions/conversation.CloseRecord"
                },
                "conversationStatus": {
                    "type": "string"
                },
