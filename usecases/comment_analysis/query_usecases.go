...
func (uc *listUseCase) Execute(ctx context.Context, in ca.ListInput) (*shared.PaginatedResult[*ca.CommentAnalysis], error) {
	in.Normalize()
...
func (uc *retryUseCase) Execute(ctx context.Context, workspaceID, id string) (*ca.CommentAnalysis, error) {
