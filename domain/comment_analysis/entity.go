...
type CommentAnalysis struct {
	...
	// SourceCommentID identifies the subject on its channel: the comment id for
...
func (a *CommentAnalysis) Kind() SubjectKind {
	if a.SubjectKind == "" {
...
func (a *CommentAnalysis) applyConversation(c Classification, prov Provenance, now time.Time) {
	a.Sentiment = c.Sentiment
