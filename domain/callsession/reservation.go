...
// CallSession implementation so the compare-and-set plus TTL-backstop logic
// lives in exactly ONE place instead of being copied per session type.
//
...
//
// CallSessionReservationTTL bounds how long a reservation can survive without an
